  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        torchBtnActive: { backgroundColor: colors.primaryLight },
        torchLabel: { fontFamily: Fonts.medium, fontSize: FontSizes.sm, color: colors.white },
        torchLabelActive: { color: colors.primary },
        closeBtn: {
          paddingVertical: Spacing.md,
          paddingHorizontal: Spacing.lg,
          backgroundColor: 'rgba(0,0,0,0.5)',
        ...
        closeText: { fontFamily: Fonts.medium, fontSize: FontSizes.md, color: colors.white },
        frame: {
          width: 280,
          height: 140,
          borderWidth: 3,
        ...
        resultBtn: { marginTop: Spacing.sm },
      }),
    [colors]
  );
          ...
          {result?.loading ? (
            ...
            <>
              ...
              <Text style={styles.resultName}>
                {result?.name || 'We couldn\'t find this product'}
              </Text>
              {!result?.name && (
                <Text style={styles.resultSubtext}>You can add it manually with the details below.</Text>
              )}
              {result?.supplier ? (
